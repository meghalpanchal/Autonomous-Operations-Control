...
function App() {
  ...
  const displayedMachineId =
    filteredMachines.length === 0
      ? selectedMachineId
      : selectedMachineIsVisible
        ? selectedMachineId
        : filteredMachines[0].machineId;

  const selectedMachine = machines.find(
    (machine) => machine.machineId === displayedMachineId,
  );
  const selectedMachineHistory = telemetryHistory[displayedMachineId] ?? [];
    ...
    <main className="min-h-screen bg-slate-100">
      <div className="mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
        ...
        <MachineSelector
          ...
          selectedMachineId={displayedMachineId}
            ...
            <section className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div className="mt-2 flex items-end gap-2">
                  ...
                  <span className="pb-1 text-sm text-slate-500">°C</span>
                </div>
              </div>
            ...
            <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <div className="divide-y divide-slate-100">
                <div className="flex items-center justify-between py-3">
                  <span className="text-sm text-slate-500">Machine ID</span>
